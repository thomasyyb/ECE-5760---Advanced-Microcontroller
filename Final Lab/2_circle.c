...
// create threads
	...
	while(1) 
	{
		...
		phasor_sum_sin_old = phasor_sum_sin; 
		phasor_sum_cos_old = phasor_sum_cos; 
		...
		// VGA_line(phasor_1_sin_old + 160, phasor_1_cos_old + 240,
		// 		 phasor_1_sin     + 160, phasor_1_cos     + 240, colors[2]);
		...
		VGA_line(phasor_sum_sin_old + center_x, phasor_sum_cos_old + center_y,
				 phasor_sum_sin     + center_x, phasor_sum_cos     + center_y, colors[6]);
